...
const int MAX_ANGLE = 5;  // Max that the servo will rotate in either direction from STARTING_ANGLE
const int RIGHT_START_ANGLE = 65; // Starting angle for a servo
const int START_ANGLE = 115;
const int SERVO_INCREMENT_DELAY = 100; // Delay between 1-degree servo increments
...
void loop()
{
  ...
  //rAngle = 0;
  //lAngle = 0;
  moveServo(yServo, RIGHT_START_ANGLE + rAngle);
